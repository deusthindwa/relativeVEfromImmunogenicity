...
p_absolute <- 
  ...
  labs(x = "Serotype", y = "Absolute vaccine efficacy \nagainst colonization (%)", colour = "Vaccine", title   = "Absolute VE against colonization, chained from RR estimates", subtitle = sprintf("Assumed VE(PCV7) = %.0f%% for PCV7 serotypes; VE(PCV7) = 0%% for the six PCV13-only serotypes", 100 * VE0, 100 * VE0)) +
