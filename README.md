...
- for serotypes in PCV7 (4, 6B, 9V, 14, 18C, 19F, 23F): VE0(PCV7) = 0.60
  ...
  VE_PCV10[s] = 1 - (1 - VE0) * RR_{13v7}[s] * RR_{13v10}[s]
  VE_PCV14[s] = 1 - (1 - VE0) * RR_{13v7}[s] * RR_{14v13}[s]
  VE_PCV15[s] = 1 - (1 - VE0) * RR_{13v7}[s] * RR_{15v13}[s]
  VE_PCV20[s] = 1 - (1 - VE0) * RR_{13v7}[s] * RR_{20v13}[s]
  ```

- for PCV13-only serotypes (1, 3, 5, 6A, 7F, 19A): PCV7 confers no antibody-mediated protection because the serotype is not in PCV7, so VE0(PCV7) = 0 and the change-point model's RR_{13v7}[s] (computed fom the head-to-head data, where PCV7-arm IgG is at baseline for these serotypes) gives the absolute VE for PCV13 directly:
  
   ```
  VE_PCV13[s] = 1 - RR_{13v7}[s]
  VE_PCV10[s] = 1 - RR_{13v7}[s] * RR_{13v10}[s]
  VE_PCV14[s] = 1 - RR_{13v7}[s] * RR_{14v13}[s]
  VE_PCV15[s] = 1 - RR_{13v7}[s] * RR_{15v13}[s]
  VE_PCV20[s] = 1 - RR_{13v7}[s] * RR_{20v13}[s]
  ```

- Note: If RR_{13v7}[s] is set to equal to 1, the we can estimate the relative of any other PCV relative to PCV13
